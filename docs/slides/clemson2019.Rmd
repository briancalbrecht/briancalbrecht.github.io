...
---
An Evolutionary Middleground
====================================

- For efficiency, as Chicago school claims, institutions must systematically  **select** for those policies
...
- **Goal**: model politics as dynamic, evolutionary process

- In politics, interest group formation replces explicit choice of politicians

---
A Selection Mechanism
====================================

- We model interest groups (Becker 1983)

- At any point in time, interest groups can leave efficiency gains on the table
...
- In the standard model, tariffs are inefficient: $B < C$
...
- Previous examples can't speak to dynamic persistence vs. temporary policies
...
- Once $C$ crosses some threshold, the consumer group will enter giving **selection**
...
- ### Proposition 3:
  - Static inefficiency $\nRightarrow$ dynamic inefficiency
...
- If $N$ is positive, current policy is **inefficient** (fails standard cost/benefit)

- In a Coasean world with no transaction costs, the policy will be overturned

- We have two frictions:
  - Organizational costs
  - Uncertainty about future cost of policy
...
- Between government failure theory and Chicago school

- Long last policies likely have a hidden efficiency justification
  - e.g. Hendrickson, Salter, and Albrecht (2018) on capital taxation
