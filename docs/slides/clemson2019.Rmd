...
3. The political sphere **selects** for efficient policies
...
- For efficiency, institutions must systematically  **select** for those policies
...
- We model interest groups, as in Becker (1983) and others
...
- ### Proposition 3:
  - Policies remain in the dynamic problem that do not in the static problem
...
- Move analysis to institutional level, compared to policy
