...
date: 'November 11, 2019<br><br> Paper `r icon::fa("link")`  [bit.ly/bca-evolution](http://bit.ly/bca-evolution) <br>`r icon::fa("twitter")` [briancalbrecht](https://twitter.com/briancalbrecht)'
output:
...
###`r icon::fa("link")` Slides: [bit.ly/bca-SEA](https://bit.ly/bca-SEA) <br>
