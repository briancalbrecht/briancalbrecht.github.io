...
---
background-image: url(https://briancalbrecht.github.io/docs/slides/images/jmp/tikz_T.png)
...
---
background-image: url(https://briancalbrecht.github.io/docs/slides/images/jmp/tikz_W.png)
background-size:contain
