...
date: '`r format(Sys.time(), "%B %d, %Y")`<br><br>Paper `r icon::fa("link")`  [bit.ly/Albrecht-JMP](http://bit.ly/Albrecht-JMP) <br>Slides `r icon::fa("link")`  [bit.ly/Albrecht-ICES](http://bit.ly/Albrecht-ICES)'
output:
...
.center[![](https://briancalbrecht.github.io/docs/slides/images/jmp/tikz_P.png)]
...
.center[![](https://briancalbrecht.github.io/docs/slides/images/jmp/tikz_R.png)]
...
.center[![](https://briancalbrecht.github.io/docs/slides/images/jmp/tikz_T.png)]
...
--
- For any price, someone wants to deviate from $(0,0)$    
...
###`r icon::fa("link")` Slides: [bit.ly/Albrecht-ICES](https://bit.ly/Albrecht-ICES) <br>
