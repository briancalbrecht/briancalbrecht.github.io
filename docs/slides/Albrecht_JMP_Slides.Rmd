...
- Coordination failure: $b=s=0$
  ...
  - **Contradicting** conjectures: 
      - To avoid buyer deviating: $\tilde{p}^i (1,1) \geq \frac{3}{4}$
      - To avoid seller deviating: $\tilde{p}^j(1,1) \leq \frac{1}{4}$
...
- For simplicity, assume no mistakes/trembles in competitive matching market 
