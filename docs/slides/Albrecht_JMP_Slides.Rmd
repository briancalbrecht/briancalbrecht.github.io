...
- With no more conditions, two investment equilibria:
  - Efficient: $b=s=1$
  - Coordination failure: $b=s=0$

- $p(0) = 0$ and $p(1) \in \left[\frac{1}{4}, \frac{3}{4}\right]$
...
- Reason: Off-path conjectures are a free parameter
  - Pick $\tilde{p}^j(s)$ sufficiently low to discourage
