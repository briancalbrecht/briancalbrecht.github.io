...
date: '`r format(Sys.time(), "%B %d, %Y")`<br><br> `r icon::fa("link")` [bit.ly/Albrecht-JMP-Slides](https://bit.ly/Albrecht-JMP-Slides)'
output:
...
- Bounded continuous value function: $v : B^0 \times S^0 \to \mathbb{R}$
  ...
  - When $v$ is not submodular, coordination problems are possible*
