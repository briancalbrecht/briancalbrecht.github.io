...
- Conjectures must disagree for any coordination failure

- This disagreement is not robust to a trembling hand
...
- Coordination failure: no one invests
  ...
  - Conjectures: 
      - To prevent buyer deviating: $\tilde{p}^\beta (1,1) = 1$
      - To prevent seller deviating: $\tilde{p}^\sigma(1,1) = 0$
...
- But the coordination failure requires contradictory beliefs

--

- To discipline beliefs and give predictive power, I introduce a mild refinement
