...
- **No mixed strategy equilibrium**
  - If other people are mixing between $(0,0)$ and $(1,1)$, each player strictly prefers $(1,1)$
  - Different from 2-player game


--

- What are the efficiency implications?
  - Weak: maximum or mininimum feasible surplus
...
- Definition: A perfect equilibrium is limit of some sequence of equilibria for $\epsilon = (\epsilon^i,\epsilon^j) \to (0,0)$
...
- Step 1: for any $\epsilon >>0$, in any equilibrium, buyers and sellers choose $(1,1)$

- Proof: Suppose for contradiction they both chose $(0,0)$
...
- Contradiction proves at least one side does not choose $(0,0)$. Same holds for $(1,0)$ and $(0,1)$

---
Supply and Demand for $(1,1)$
==========

- If $p(1,1)$ is low $(< \frac{3}{4})$, all buyers want to choose $b=1$ as much as possible: $1 - \epsilon^i$

  - Drives $p(1,1)$ up
  
--

- If $p(1,1)$ is high $(> \frac{1}{4})$, no sellers want to choose $s=1$ as much as possible: $1 - \epsilon^j$
...
- At that price, everyone wants to invest if they can match
  - $\text{min}\left\{1- \epsilon^i, 1- \epsilon^j\right\}$ invest on both sides


???
Draw demand and supply for (1,1) market
---
...
- For every $\epsilon \to (0,0)$, $(1,1)$ is the unique equilibrium strategy profile $\blacksquare$
