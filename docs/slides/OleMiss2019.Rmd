...
---
<img src="https://briancalbrecht.github.io/docs/slides/images/jmp/tikz_D.png" class="center70">

--

- Two equilibria

  1. Efficient Coordination: (Invest, Invest)
  2. Coordination Failure: (Don't Invest, Don't Invest)

--

- With 2 players, both are robust to perturbations

--

- What if there are many potential entrepreneurs in the market?
---
My Question
====================================
...
- With consistent conjectures for all players, total welfare = efficiency $\blacksquare$
...
Main theorem: Modified First Welfare Theorem
  ...
  - Even with **incomplete and endogenous markets**, every perfect, investment equilibrium is efficient
