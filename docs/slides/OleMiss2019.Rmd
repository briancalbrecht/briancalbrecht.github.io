...
- Some $p(1,1) \in \left[\frac{1}{4}, \frac{3}{4}\right]$ balances supply and demand and clears all markets
...
As in any theory paper, complications arise, *e.g.*

1. I need to define trembles and perfect equilibrium with a continuum of players

2. I model an explicit matching market, given fixed investments, compared to picking a match ex ante
