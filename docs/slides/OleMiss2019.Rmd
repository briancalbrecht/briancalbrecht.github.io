...
Coordination Game
====================================
<img src="https://briancalbrecht.github.io/docs/slides/images/jmp/tikz_D.png" width="800" class="center">

- Efficient Coordination: (Invest, Invest)

- Coordination Failure; (Don't Invest, Don't Invest)

- But what if there are many software and hardware entrepreneurs?
---
My Question
====================================


- Are the investments we see out in the world (with many entrepreneurs) likely to be inefficient? 
...
$$\int_i  \left[\max_b v(b,s) - p (b,s) - c\left(\beta(i), b\right)\right] di  + \int_j \left[\max_s  p (b,s)  - c\left(\sigma (j), s\right)\right] dj.$$
