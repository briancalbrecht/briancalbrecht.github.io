...
- What are the efficiency implications?
  - Weak: maximum or minimum feasible surplus
...
- Contradiction proves one side does not choose $(0,0)$.  If one side does not, market clearing implies the other side does not

- Same argumnet holds for $(1,0)$ and $(0,1)$
...
- If $p(1,1)$ is low $(< \frac{3}{4})$, all buyers want to choose $b=1$ as much as possible: $1 - \epsilon(b)$

  - Drives $p(1,1)$ up
  
--

- If $p(1,1)$ is high $(> \frac{1}{4})$, no sellers want to choose $s=1$ as much as possible: $1 - \epsilon(s)$
