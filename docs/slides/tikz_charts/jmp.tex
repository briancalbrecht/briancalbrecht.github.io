...
\draw[thick,<->] (0,10) node[above]{Optimal Investment}--(0,0)--(10,0) node[right]{Average Investment};

\node [below left] at (0,0) {$0$};

\draw(0,0)--(9,9) node[above right]{$ 45^{\circ}$};
...
\begin{figure}
	...
	\node [above] at (3,6.2) {\Large Market for $(1,1)$, Given Conjectures};
...
\begin{figure}
	...
	(4,5) -- (4,5/4) node [right,red,midway,xshift=.5cm] {Set of Equilibrium Prices};
