...
\begin{figure}[h]
	...
	\node[above=5pt of a,anchor=base] {Don't Innovate};
	\node[above=5pt of b,anchor=base] {Innovate};
	
	\coordinate (c) at ($(m.north west)!0.25!(m.south west)$);
	\coordinate (d) at ($(m.north west)!0.75!(m.south west)$);
	\node[left=6pt of c,text width=3cm]  {Don't Innovate};
	\node[left=6pt of d,text width=3cm]  {Innovate};
	
	\node[above=18pt of m.north] (firm b) {Software Developer};
	\node[left=4cm of m.west,rotate=90,align=center,anchor=center] {Hardware Developer};
